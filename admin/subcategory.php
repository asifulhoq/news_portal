                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
								...
								<div class="form-row">
                                    <div class="col-6">
                                    <div class="form-group"><label for="subcatname"><strong>Select Category</strong></label><select class="form-control" name="category" required>
													<option value="">Select Category </option>
													<?php
													// Feching active categories
													$ret=mysqli_query($conn,"select id,catname from  category order by id");
													while($result=mysqli_fetch_array($ret))
													{    
													?>
