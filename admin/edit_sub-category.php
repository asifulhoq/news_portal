...
include("function.php");
        ...
        if(isset($_POST["update"]))
        {
           ...
           $sql =  "UPDATE subcat set subcatname = '$subcatname', subcatdes = '$subcatdes' WHERE id='$id'";
           $record = $conn->query($sql);
            if($record) 
            {
                echo "Updated Successfully!";
                //header("Location: member_detail.php?eid=$emp_id");
                echo "<meta http-equiv='refresh' content='1;url=sub-category.php'>";
                exit();
            }
        ...
        if(isset($_GET['id'])) 
        {
            ...
            //echo $subcatname.'_'.$subcatdes;die;
            ...
            <div class="container-fluid">
                <div class="card shadow mb-5">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                <form action="edit_sub-category.php" method="POST">
                                <div class="form-row">
                                    <div class="col-6">
                                    <div class="form-group"><label for="subcatname"><strong>Subcategory Name</strong></label><input class="form-control" type="text"  value="<?php echo $subcatname; ?>" placeholder="" name="subcatname"></div>
                                    </div>
                                    <div class="form-group"><label for="subcatdes"><strong>Description</strong><br></label><textarea class="form-control" rows="4" name="subcatdes"><?php echo $subcatdes; ?></textarea></div>
