		...
		<div class="container-menu-desktop">
			...
			<div class="menu-mobile">
				...
				<ul class="main-menu-m">
					...
					<li>
						<a href="life_style.php">Life Style</a>
					</li>

					<li>
						<a href="entertainment.php">Video</a>
					</li>
						...
						<ul class="main-menu">
							...
							<li class="mega-menu-item">
								...
								<div class="sub-mega-menu">
									<div class="nav flex-column nav-pills" role="tablist">
										...
										<a class="nav-link" data-toggle="pill" href="#enter-2" role="tab">Film</a>
										<a class="nav-link" data-toggle="pill" href="#enter-3" role="tab">Music</a>
										<a class="nav-link" data-toggle="pill" href="#enter-4" role="tab">Game</a>
										<a class="nav-link" data-toggle="pill" href="#enter-5" role="tab">Glamour</a>
									</div>
										...
										<div class="tab-pane show active" id="enter-1" role="tabpanel">
											<div class="row">
												<div class="col-3">
													<!-- Item post -->	
													<div>
														<a href="blog_detail.php" class="wrap-pic-w hov1 trans-03">
															<img src="images/post-25.jpg" alt="IMG">
														</a>

														<div class="p-t-10">
															<h5 class="p-b-5">
																<a href="blog_detail.php" class="f1-s-5 cl3 hov-cl10 trans-03">
							...
							<li class="mega-menu-item">
								...
								<div class="sub-mega-menu">
									<div class="nav flex-column nav-pills" role="tablist">
										<a class="nav-link active" data-toggle="pill" href="#enter-1" role="tab">All</a>
										<a class="nav-link" data-toggle="pill" href="#enter-2" role="tab">Cricket</a>
										<a class="nav-link" data-toggle="pill" href="#enter-3" role="tab">Football</a>
										<a class="nav-link" data-toggle="pill" href="#enter-4" role="tab">Tennis</a>
										<a class="nav-link" data-toggle="pill" href="#enter-5" role="tab">Others</a>
									</div>
							...
							<li class="mega-menu-item">
								...
								<div class="sub-mega-menu">
									<div class="nav flex-column nav-pills" role="tablist">
										<a class="nav-link active" data-toggle="pill" href="#technology-1" role="tab">All</a>
										<a class="nav-link" data-toggle="pill" href="#technology-2" role="tab">Information Technology</a>
										<a class="nav-link" data-toggle="pill" href="#technology-3" role="tab">Robotics</a>
										<a class="nav-link" data-toggle="pill" href="#technology-4" role="tab">Artificial Intelligence</a>
									</div>

									<div class="tab-content">
										<div class="tab-pane show active" id="technology-1" role="tabpanel">
											<div class="row">
												<div class="col-3">
													<!-- Item post -->	
													<div>
										...
										<div class="tab-pane" id="technology-2" role="tabpanel">
											<div class="row">
												<div class="col-3">
													<!-- Item post -->	
													<div>
	...
	<div class="container">
		<div class="bg0 flex-wr-sb-c p-rl-20 p-tb-8">
			<div class="f2-s-1 p-r-30 m-tb-6">
				...
				<a href="entertainment.php" class="breadcrumb-item f1-s-3 cl9">
					Category
				</a>
			...
			<div class="row m-rl--1">
				<div class="col-12 p-rl-1 p-b-2">
					<div class="bg-img1 size-a-3 how1 pos-relative" style="background-image: url(images/entertaiment-16.jpg);">
						<a href="blog_detail.php" class="dis-block how1-child1 trans-03"></a>
						...
						<div class="flex-col-e-s s-full p-rl-25 p-tb-20">
							...
							<h3 class="how1-child2 m-t-14 m-b-10">
								<a href="blog_detail.php" class="how-txt1 size-a-6 f1-l-1 cl0 hov-cl10 trans-03">
					...
					<div class="bg-img1 size-a-14 how1 pos-relative" style="background-image: url(images/entertaiment-02.jpg);">
						...
						<div class="flex-col-e-s s-full p-rl-25 p-tb-20">
							...
							<h3 class="how1-child2 m-t-14">
								<a href="blog_detail.php" class="how-txt1 size-h-1 f1-m-1 cl0 hov-cl10 trans-03">
							...
							<div class="p-b-53">
								...
								<div class="flex-col-s-c p-t-16">
									<h5 class="p-b-5 txt-center">
										<a href="blog_detail.php" class="f1-m-3 cl2 hov-cl10 trans-03">
									...
									<a href="blog_detail.php" class="f1-s-1 cl9 hov-cl10 trans-03">
										Read More
