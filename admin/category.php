...
<?php
 ...
 include("function.php");
        ...
        if(isset($_POST["save"]))
        {
            ...
            //echo "INSERT INTO category(catname, catdes) VALUES('$catname','$catdes')"; die;


            $result= $conn->query( "INSERT INTO category(catname, catdes) VALUES ('$catname','$catdes')");
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
								...
								<div class="form-row">
                                    <div class="col-6">
                                    <div class="form-group"><label for="catname"><strong>Category Name</strong></label><input class="form-control" type="text" placeholder="" name="catname"></div>
                                    </div>
                                    <div class="form-group"><label for="catdes"><strong>Description</strong><br></label><textarea class="form-control" rows="4" name="catdes"></textarea></div>
		            ...
		            <?php
						...
						while($row = mysqli_fetch_array($rec))
						{
							...
							echo "<tr>
								...
								<td>$catdes</td>
								<td>
									<a href='edit_category.php?id=$id' class='button1'>Edit</a> | 
